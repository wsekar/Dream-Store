								...
								<div class="card-body">
									<form action="<?= base_url('pengguna/proses_ubah/' . $pengguna->id) ?>" id="form-tambah" method="POST">
										...
										<div class="form-group ">
											...
											<input type="text" name="nama_pengguna" placeholder="Masukkan Nama Pengguna" autocomplete="off" class="form-control js-name" required value="<?= $pengguna->nama_pengguna ?>">
										</div>
										...
										<div class="form-group ">
											...
											<input type="text" name="password_pengguna" placeholder="Masukkan Password" autocomplete="off" class="form-control" required value="<?= $pengguna->password_pengguna ?>" minlength="8">
										</div>
										<hr>
										<div class="form-group">
